...
public interface BlindboxDao {
    ...
    List<Blindbox> selectByExampleWithBLOBs(BlindboxExample example);
    ...
    int updateByExampleWithBLOBs(@Param("record") Blindbox record, @Param("example") BlindboxExample example);
    ...
    int updateByPrimaryKeyWithBLOBs(Blindbox record);
