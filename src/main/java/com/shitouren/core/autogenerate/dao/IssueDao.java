...
public interface IssueDao {
    ...
    int increaseSoldByPrimaryKey(@Param("id") Integer id, @Param("count") Integer count);

    int updateSoldByCAS(@Param("id") Integer id, @Param("sold") Integer sold, @Param("oldSold") Integer oldSold);
