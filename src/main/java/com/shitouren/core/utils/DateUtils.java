...
public class DateUtils {
    ...
    public static String getDate(Date date) {
        ...
        return DateFormatUtils.format(date, DateUtils.DATETIME_FORMAT);
    }
...
//    }
    ...
    public static long getMilliSecondEndOfDay(Date date) {
        Timestamp endTime = getDayEndTime(date);
        return endTime.getTime() - date.getTime();
    }

    public static long getSecondEndOfDay(Date date) {
        return getMilliSecondEndOfDay(date) / 1000;
    }

    public static long getSecondEndOfDay() {
        return getMilliSecondEndOfDay(new Date()) / 1000;
    }

    public static void main(String[] args) {
        System.out.println("getDayBegin() = " + getDayBegin());
        System.out.println("getBeginDayOfYesterday() = " + getBeginDayOfYesterday());
        System.out.println(getSecondEndOfDay(new Date()));
    }
}
